...
export const example = async () => {
  const pk = "0x1fdc1c1014447d770b85ef507c256ffa5a186095948aadb0c28a76688d99d288";

  const core = Core.fromPrivateKey(pk);
  const arianeeAccessToken = new ArianeeAccessToken(core);
  const aat = await arianeeAccessToken.getValidWalletAccessToken({ id: "monSecondzefUser" });
  console.log(aat);
